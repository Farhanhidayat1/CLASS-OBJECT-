...
public class main {
	...
	public main(String[] args) {
		...
		System.out.println("lebar : " + main.getluas());
		...
		mahasiswa.setnama ("MUHAMMAD YUSUF");
		mahasiswa.setnama ("D0217032");
		mahasiswa.setalamat ("PASA'BU");
		mahasiswa.setgolonganDarah ("O");
